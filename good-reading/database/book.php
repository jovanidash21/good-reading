                                        ...
                                        <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $bookResult = $connect->query($book);
                                                    if($bookResult->num_rows > 0)
                                                    {
                                                        while($bookRows = $bookResult->fetch_assoc())
                                                        {
                                                            $book_number = $bookRows['book_number'];
                                                            $book_name = $bookRows['book_name'];
                                                            $publication_year = $bookRows['publication_year'];
                                                            $pages = $bookRows['pages'];
                                                            $publisher_name = $bookRows['publisher_name'];
                                                            echo 
                                                                "<tr>
                                                                    <td>"
                                                                        .$book_number.
