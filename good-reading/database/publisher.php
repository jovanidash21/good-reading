                                        ...
                                        <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $publisherResult = $connect->query($publisher);
                                                    if($publisherResult->num_rows > 0)
                                                    {
                                                        while($publisherRows = $publisherResult->fetch_assoc())
                                                        {
                                                            $publisher_name = $publisherRows['publisher_name'];
                                                            $city = $publisherRows['city'];
                                                            $country = $publisherRows['country'];
                                                            $telephone = $publisherRows['telephone'];
                                                            $year_founded = $publisherRows['year_founded'];
                                                            echo 
                                                                "<tr>
                                                                    <td>"
                                                                        .$publisher_name.
