            ...
            <nav class="navbar navbar-default navbar-fixed-top navbar-top">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <button type="button" class="navbar-right-expand-toggle pull-right visible-xs">
                            <i class="fa fa-times icon">Wrote</i>
                        </button>
                                        ...
                                        <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $wrote = "SELECT * FROM wrote";
                                                    $wroteResult = $connect->query($wrote);
                                                    if($wroteResult->num_rows > 0)
                                                    {
                                                        while($wroteRows = $wroteResult->fetch_assoc())
                                                        {
                                                            $book_number = $wroteRows['book_number'];
                                                            $author_number = $wroteRows['author_number'];
                                                            echo 
                                                                "<tr>
                                                                    <td>"
                                                                        .$book_number.
