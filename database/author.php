                                        ...
                                        <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $authorResult = $connect->query($author);
                                                    if($authorResult->num_rows > 0)
                                                    {
                                                        while($authorRows = $authorResult->fetch_assoc())
                                                        {
                                                            $author_number = $authorRows['author_number'];
                                                            $author_name = $authorRows['author_name'];
                                                            $year_born = $authorRows['year_born'];
                                                            $year_died = $authorRows['year_died'];
                                                            echo 
                                                                "<tr>
                                                                    <td>"
                                                                        .$author_number.
