                                        ...
                                        <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $customerResult = $connect->query($customer);
                                                    if($customerResult->num_rows > 0)
                                                    {
                                                        while($customerRows = $customerResult->fetch_assoc())
                                                        {
                                                            $customer_number = $customerRows['customer_number'];
                                                            $customer_name = $customerRows['customer_name'];
                                                            $street = $customerRows['street'];
                                                            $city = $customerRows['city'];
                                                            $state = $customerRows['state'];
                                                            $country = $customerRows['country'];
                                                            echo 
                                                                "<tr>
                                                                    <td>"
                                                                        .$customer_number.
